  ...
  <body class="vertical-layout vertical-menu-modern material-vertical-layout material-layout 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item mr-auto"><a class="navbar-brand" href="/"><img class="brand-logo" alt="modern admin logo" src="app-assets/images/logo/logo.png">
                <h3 class="brand-text">Modern</h3></a></li>
                <li onclick="myFunction()" class="nav-item d-none d-lg-block nav-toggle"><a class="nav-link modern-nav-toggle pr-0" data-toggle="collapse"><i class="toggle-icon ft-toggle-right font-medium-3 white" data-ticon="ft-toggle-right"></i></a></li>
              ...
              <li class="dropdown nav-item mega-dropdown d-none d-lg-block"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
                <ul class="mega-dropdown-menu dropdown-menu row p-1">
                  ...
                  <li class="col-md-5 px-2">
                    ...
                    <ul class="row mt-2">
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/ecommerce-menu-template" target="_blank"><i class="la la-shopping-cart font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-0">eCommerce</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/travel-menu-template" target="_blank"><i class="la la-plane font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-0">Travel</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3 mt-75 mt-xl-0" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/hospital-menu-template" target="_blank"><i class="la la-stethoscope font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-0">Hospital</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/crypto-menu-template" target="_blank"><i class="la la-bitcoin font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-50">Crypto</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/support-menu-template" target="_blank"><i class="la la-tag font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-50">Support</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/bank-menu-template" target="_blank"><i class="la la-bank font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-50">Bank</p></a></li>
                    </ul>
                  </li>
                  <li class="col-md-3">
    ...
    <div class="main-menu material-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="user-profile">
        <div class="user-info text-center pb-2"><img class="user-img img-fluid rounded-circle w-25 mt-2" src="<?php if(!empty($GetAdminProfile['img'])){  echo "pages/dashboard/images/".$GetAdminProfile['img']; }else{ echo "pages/dashboard/images/avartar/6596121.png"; } ?>" alt=""/>
          <div class="name-wrapper d-block dropdown mt-1"><a class="white dropdown-toggle" id="user-account" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-name"><?=$GetAdminProfile['username'];?></span></a>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" nav-item"><a href="index.php"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Dashboard</span><span class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="raw/dashboard-ecommerce.html"><i class="material-icons"></i><span data-i18n="eCommerce">eCommerce</span></a>
              </li>
              <li><a class="menu-item" href="raw/dashboard-crypto.html"><i class="material-icons"></i><span data-i18n="Crypto">Crypto</span></a>
              </li>
              <li class="active"><a class="menu-item" href="dashboard-sales.html"><i class="material-icons"></i><span data-i18n="Sales">Sales</span></a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="material-icons">tv</i><span class="menu-title" data-i18n="Templates">Templates</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Vertical">Vertical</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-menu-template"><i class="material-icons"></i><span data-i18n="Classic Menu">Classic Menu</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-compact-menu-template"><i class="material-icons"></i><span data-i18n="Compact Menu">Compact Menu</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-collapsed-menu-template"><i class="material-icons"></i><span data-i18n="Collapsed Menu">Collapsed Menu</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-modern-menu-template"><i class="material-icons"></i><span>Modern Menu</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-content-menu-template"><i class="material-icons"></i><span data-i18n="Content Menu">Content Menu</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-overlay-menu-template"><i class="material-icons"></i><span data-i18n="Overlay Menu">Overlay Menu</span></a>
                  </li>
                </ul>
              </li>
              <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Horizontal">Horizontal</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-horizontal-menu-template"><i class="material-icons"></i><span data-i18n="Classic">Classic</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-horizontal-menu-template-nav"><i class="material-icons"></i><span data-i18n="Full Width">Full Width</span></a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li class=" nav-item"><a href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-ecommerce-menu-template" target="_blank"><i class="material-icons">add_shopping_cart</i><span class="menu-title" data-i18n="eCommerce">eCommerce</span></a>
          </li>
          <li class=" nav-item"><a href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-travel-menu-template" target="_blank"><i class="material-icons">call_merge</i><span class="menu-title" data-i18n="Travel &amp; Booking">Travel &amp; Booking</span></a>
          </li>
          <li class=" nav-item"><a href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-hospital-menu-template" target="_blank"><i class="material-icons">add_circle_outline</i><span class="menu-title" data-i18n="Hospital">Hospital</span></a>
          </li>
          <li class=" nav-item"><a href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-crypto-menu-template" target="_blank"><i class="material-icons">attach_money</i><span class="menu-title" data-i18n="Crypto">Crypto</span></a>
          </li>
          <li class=" nav-item"><a href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-support-menu-template" target="_blank"><i class="material-icons">label_outline</i><span class="menu-title" data-i18n="Support Ticket">Support Ticket</span></a>
          </li>
          <li class=" nav-item"><a href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-bank-menu-template" target="_blank"><i class="material-icons">account_balance</i><span class="menu-title" data-i18n="Bank">Bank</span></a>
          </li>
          ...
          <li class=" nav-item"><a href="raw/app-todo.html"><i class="material-icons">playlist_add_check</i><span class="menu-title" data-i18n="ToDo">ToDo</span></a>
          </li>
          <li class=" nav-item"><a href="raw/app-contacts.html"><i class="material-icons">people_outline</i><span class="menu-title" data-i18n="Contacts">Contacts</span></a>
          </li>
          <li class=" nav-item"><a href="raw/app-email.html"><i class="material-icons">mail_outline</i><span class="menu-title" data-i18n="Email">Email</span></a>
          </li>
          <li class=" nav-item"><a href="raw/app-chat.html"><i class="material-icons">chat_bubble_outline</i><span class="menu-title" data-i18n="Chat">Chat</span></a>
          </li>
          <li class=" nav-item"><a href="raw/app-kanban.html"><i class="material-icons">playlist_add_check</i><span class="menu-title" data-i18n="Kanban">Kanban</span></a>
          </li>
          ...
          <li class=" nav-item"><a href="#"><i class="material-icons">event</i><span class="menu-title" data-i18n="Calendars">Calendars</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Full Calendar">Full Calendar</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="raw/full-calender-basic.html"><i class="material-icons"></i><span data-i18n="Basic">Basic</span></a>
                  </li>
                  <li><a class="menu-item" href="raw/full-calender-events.html"><i class="material-icons"></i><span data-i18n="Events">Events</span></a>
                  </li>
                  <li><a class="menu-item" href="raw/full-calender-advance.html"><i class="material-icons"></i><span data-i18n="Advance">Advance</span></a>
                  </li>
                  <li><a class="menu-item" href="raw/full-calender-extra.html"><i class="material-icons"></i><span data-i18n="Extra">Extra</span></a>
                  </li>
                </ul>
              </li>
          ...
          <li class=" nav-item"><a href="raw/news-feed.html"><i class="material-icons">library_books</i><span class="menu-title" data-i18n="News Feed">News Feed</span></a>
          </li>
          <li class=" nav-item"><a href="raw/social-feed.html"><i class="material-icons">stay_current_portrait</i><span class="menu-title" data-i18n="Social Feed">Social Feed</span></a>
          </li>
          <li class=" nav-item"><a href="#"><i class="material-icons">content_paste</i><span class="menu-title" data-i18n="Invoice">Invoice</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="raw/invoice-summary.html"><i class="material-icons"></i><span data-i18n="Invoice Summary">Invoice Summary</span></a>
              </li>
              <li><a class="menu-item" href="raw/invoice-template.html"><i class="material-icons"></i><span data-i18n="Invoice Template">Invoice Template</span></a>
              </li>
              <li><a class="menu-item" href="raw/invoice-list.html"><i class="material-icons"></i><span data-i18n="Invoice List">Invoice List</span></a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="material-icons">timeline</i><span class="menu-title" data-i18n="Timelines">Timelines</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="raw/timeline-center.html"><i class="material-icons"></i><span data-i18n="Timelines Center">Timelines Center</span></a>
              </li>
              <li><a class="menu-item" href="raw/timeline-left.html"><i class="material-icons"></i><span data-i18n="Timelines Left">Timelines Left</span></a>
              </li>
              <li><a class="menu-item" href="raw/timeline-right.html"><i class="material-icons"></i><span data-i18n="Timelines Right">Timelines Right</span></a>
              </li>
              <li><a class="menu-item" href="raw/timeline-horizontal.html"><i class="material-icons"></i><span data-i18n="Timelines Horizontal">Timelines Horizontal</span></a>
              </li>
            </ul>
          </li>
          ...
          <li class=" nav-item"><a href="#"><i class="material-icons">person_outline</i><span class="menu-title" data-i18n="Users">Users</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="raw/page-users-list.html"><i class="material-icons"></i><span data-i18n="Users List">Users List</span></a>
              </li>
              <li><a class="menu-item" href="raw/page-users-view.html"><i class="material-icons"></i><span data-i18n="Users View">Users View</span></a>
              </li>
              <li><a class="menu-item" href="raw/page-users-edit.html"><i class="material-icons"></i><span data-i18n="Users Edit">Users Edit</span></a>
              </li>
          ...
          <li class=" nav-item"><a href="#"><i class="material-icons">wallpaper</i><span class="menu-title" data-i18n="Gallery">Gallery</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="raw/gallery-grid.html"><i class="material-icons"></i><span data-i18n="Gallery Grid">Gallery Grid</span></a>
              </li>
              <li><a class="menu-item" href="raw/gallery-grid-with-desc.html"><i class="material-icons"></i><span data-i18n="Gallery Grid with Desc">Gallery Grid with Desc</span></a>
              </li>
              <li><a class="menu-item" href="raw/gallery-masonry.html"><i class="material-icons"></i><span data-i18n="Masonry Gallery">Masonry Gallery</span></a>
              </li>
              <li><a class="menu-item" href="raw/gallery-masonry-with-desc.html"><i class="material-icons"></i><span data-i18n="Masonry Gallery with Desc">Masonry Gallery with Desc</span></a>
              </li>
              <li><a class="menu-item" href="raw/gallery-hover-effects.html"><i class="material-icons"></i><span data-i18n="Hover Effects">Hover Effects</span></a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="material-icons">search</i><span class="menu-title" data-i18n="Search">Search</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="raw/search-page.html"><i class="material-icons"></i><span data-i18n="Search Page">Search Page</span></a>
              </li>
              <li><a class="menu-item" href="raw/search-website.html"><i class="material-icons"></i><span data-i18n="Search Website">Search Website</span></a>
              </li>
              <li><a class="menu-item" href="raw/search-images.html"><i class="material-icons"></i><span data-i18n="Search Images">Search Images</span></a>
              </li>
              <li><a class="menu-item" href="raw/search-videos.html"><i class="material-icons"></i><span data-i18n="Search Videos">Search Videos</span></a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="material-icons">lock_outline</i><span class="menu-title" data-i18n="Authentication">Authentication</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="raw/login-simple.html" target="_blank"><i class="material-icons"></i><span data-i18n="Login Simple">Login Simple</span></a>
              </li>
              <li><a class="menu-item" href="raw/login-with-bg.html" target="_blank"><i class="material-icons"></i><span data-i18n="Login with Bg">Login with Bg</span></a>
              </li>
              <li><a class="menu-item" href="raw/login-with-bg-image.html" target="_blank"><i class="material-icons"></i><span data-i18n="Login with Bg Image">Login with Bg Image</span></a>
              </li>
              <li><a class="menu-item" href="raw/login-with-navbar.html" target="_blank"><i class="material-icons"></i><span data-i18n="Login with Navbar">Login with Navbar</span></a>
              </li>
              <li><a class="menu-item" href="raw/login-advanced.html" target="_blank"><i class="material-icons"></i><span data-i18n="Login Advanced">Login Advanced</span></a>
              </li>
              <li><a class="menu-item" href="raw/register-simple.html" target="_blank"><i class="material-icons"></i><span data-i18n="Register Simple">Register Simple</span></a>
              </li>
              <li><a class="menu-item" href="raw/register-with-bg.html" target="_blank"><i class="material-icons"></i><span data-i18n="Register with Bg">Register with Bg</span></a>
              </li>
              <li><a class="menu-item" href="raw/register-with-bg-image.html" target="_blank"><i class="material-icons"></i><span data-i18n="Register with Bg Image">Register with Bg Image</span></a>
              </li>
              <li><a class="menu-item" href="raw/register-with-navbar.html" target="_blank"><i class="material-icons"></i><span data-i18n="Register with Navbar">Register with Navbar</span></a>
              </li>
              <li><a class="menu-item" href="raw/register-advanced.html" target="_blank"><i class="material-icons"></i><span data-i18n="Register Advanced">Register Advanced</span></a>
              </li>
              <li><a class="menu-item" href="raw/unlock-user.html" target="_blank"><i class="material-icons"></i><span data-i18n="Unlock User">Unlock User</span></a>
              </li>
              <li><a class="menu-item" href="raw/recover-password.html" target="_blank"><i class="material-icons"></i><span data-i18n="recover-password">recover-password</span></a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="material-icons">error_outline</i><span class="menu-title" data-i18n="Error">Error</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="raw/error-400.html"><i class="material-icons"></i><span data-i18n="Error 400">Error 400</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-400-with-navbar.html"><i class="material-icons"></i><span data-i18n="Error 400 with Navbar">Error 400 with Navbar</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-401.html"><i class="material-icons"></i><span data-i18n="Error 401">Error 401</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-401-with-navbar.html"><i class="material-icons"></i><span data-i18n="Error 401 with Navbar">Error 401 with Navbar</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-403.html"><i class="material-icons"></i><span data-i18n="Error 403">Error 403</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-403-with-navbar.html"><i class="material-icons"></i><span data-i18n="Error 403 with Navbar">Error 403 with Navbar</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-404.html"><i class="material-icons"></i><span data-i18n="Error 404">Error 404</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-404-with-navbar.html"><i class="material-icons"></i><span data-i18n="Error 404 with Navbar">Error 404 with Navbar</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-500.html"><i class="material-icons"></i><span data-i18n="Error 500">Error 500</span></a>
              </li>
              <li><a class="menu-item" href="raw/error-500-with-navbar.html"><i class="material-icons"></i><span data-i18n="Error 500 with Navbar">Error 500 with Navbar</span></a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="material-icons">filter_2</i><span class="menu-title" data-i18n="Others">Others</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Coming Soon">Coming Soon</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="raw/coming-soon-flat.html"><i class="material-icons"></i><span data-i18n="Flat">Flat</span></a>
                  </li>
                  <li><a class="menu-item" href="raw/coming-soon-bg-image.html"><i class="material-icons"></i><span data-i18n="Bg image">Bg image</span></a>
                  </li>
                  <li><a class="menu-item" href="raw/coming-soon-bg-video.html"><i class="material-icons"></i><span data-i18n="Bg video">Bg video</span></a>
                  </li>
                </ul>
              </li>
          ...
          <li class=" nav-item"><a href="raw/pricing.html"><i class="material-icons">attach_money</i><span class="menu-title" data-i18n="Pricing">Pricing</span></a>
          </li>
          <li class=" nav-item"><a href="raw/checkout-form.html"><i class="material-icons">credit_card</i><span class="menu-title" data-i18n="Checkout">Checkout</span></a>
          </li>
          <li class=" nav-item"><a href="raw/faq.html"><i class="material-icons">help_outline</i><span class="menu-title" data-i18n="FAQ">FAQ</span></a>
          </li>
          <li class=" nav-item"><a href="raw/knowledge-base.html"><i class="material-icons">info_outline</i><span class="menu-title" data-i18n="Knowledge Base">Knowledge Base</span></a>
          </li>
          ...
          <li class=" nav-item"><a href="#"><i class="material-icons">arrow_downward</i><span class="menu-title" data-i18n="Vertical Nav">Vertical Nav</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Navigation Types">Navigation Types</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-menu-template"><i class="material-icons"></i><span data-i18n="Vertical Menu">Vertical Menu</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-modern-menu-template"><i class="material-icons"></i><span data-i18n="Vertical Modern Menu">Vertical Modern Menu</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-overlay-menu-template"><i class="material-icons"></i><span data-i18n="Vertical Overlay">Vertical Overlay</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-compact-menu-template"><i class="material-icons"></i><span data-i18n="Vertical Compact">Vertical Compact</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-vertical-content-menu-template"><i class="material-icons"></i><span data-i18n="Vertical Content">Vertical Content</span></a>
                  </li>
                </ul>
              </li>
          ...
          <li class=" nav-item"><a href="#"><i class="material-icons">arrow_forward</i><span class="menu-title" data-i18n="Horizontal Nav">Horizontal Nav</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Navigation Types">Navigation Types</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-horizontal-menu-template"><i class="material-icons"></i><span data-i18n="Left Icon Navigation">Left Icon Navigation</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/html/ltr/material-horizontal-menu-template-nav"><i class="material-icons"></i><span data-i18n="Top Icon Navigation">Top Icon Navigation</span></a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li class=" nav-item"><a href="#"><i class="material-icons">code</i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-1-column.html"><i class="material-icons"></i><span data-i18n="1 column">1 column</span></a>
              </li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-2-columns.html"><i class="material-icons"></i><span data-i18n="2 columns">2 columns</span></a>
              </li>
              <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Content Det. Sidebar">Content Det. Sidebar</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-content-detached-left-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached left sidebar">Detached left sidebar</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-content-detached-left-sticky-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached sticky left sidebar">Detached sticky left sidebar</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-content-detached-right-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached right sidebar">Detached right sidebar</span></a>
                  </li>
                  <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-content-detached-right-sticky-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached sticky right sidebar">Detached sticky right sidebar</span></a>
                  </li>
                </ul>
              </li>
              <li class="navigation-divider"></li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed-navbar.html"><i class="material-icons"></i><span data-i18n="Fixed navbar">Fixed navbar</span></a>
              </li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed-navigation.html"><i class="material-icons"></i><span data-i18n="Fixed navigation">Fixed navigation</span></a>
              </li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed-navbar-navigation.html"><i class="material-icons"></i><span data-i18n="Fixed navbar &amp; navigation">Fixed navbar &amp; navigation</span></a>
              </li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed-navbar-footer.html"><i class="material-icons"></i><span data-i18n="Fixed navbar &amp; footer">Fixed navbar &amp; footer</span></a>
              </li>
              <li class="navigation-divider"></li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed.html"><i class="material-icons"></i><span data-i18n="Fixed layout">Fixed layout</span></a>
              </li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-boxed.html"><i class="material-icons"></i><span data-i18n="Boxed layout">Boxed layout</span></a>
              </li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-static.html"><i class="material-icons"></i><span data-i18n="Static layout">Static layout</span></a>
              </li>
              <li class="navigation-divider"></li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-light.html"><i class="material-icons"></i><span data-i18n="Light layout">Light layout</span></a>
              </li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-dark.html"><i class="material-icons"></i><span data-i18n="Dark layout">Dark layout</span></a>
              </li>
              <li><a class="menu-item" href="https://demos.pixinvent.com/modern-html-admin-template/starter-kit/ltr/material-vertical-modern-menu-template/layout-semi-dark.html"><i class="material-icons"></i><span data-i18n="Semi dark layout">Semi dark layout</span></a>
              </li>
            </ul>
          </li>
          ...
          <li class=" nav-item"><a href="https://demos.pixinvent.com/modern-html-admin-template/documentation" target="_blank"><i class="material-icons">format_size</i><span class="menu-title" data-i18n="Documentation">Documentation</span></a>
          </li>
        </ul>
      </div>
    </div>
